...
export function AutomationCard({ automation }: AutomationCardProps) {
  ...
  return (
    <Card className="flex h-full flex-col gap-4">
      ...
      <div className="mt-auto flex items-center justify-between gap-3 border-t border-[var(--ra-cream-08)] pt-4">
        ...
        {link && (
          <a
            ...
            className="inline-flex shrink-0 items-center gap-1 text-xs font-medium text-primary-400 hover:text-primary-300 transition-colors"
          >
            View
